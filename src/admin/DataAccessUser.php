...
class User
{
    ...
    public function UserDbCreate($data)
    {
        ...
        $sql = "INSERT INTO $this->table_name (name, tel, email, gender, genre, pref, datetimelocal, textarea, password, checkbox_name, user_agent, ip_address) VALUES (:name, :tel, :email, :gender, :genre, :pref, :datetimelocal, :textarea, :password, :checkbox_name, :user_agent, :ip_address)";
        ...
        try {
            ...
            throw new Exception('登録に失敗しました'); // 例外をスローする
        }
    }
